    ...
    <header className="bg-white/95 backdrop-blur-xl border-b border-gray-200/80 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 py-3 sm:px-6 sm:py-4">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <Link href="/" prefetch={true} className="flex items-center space-x-1.5 sm:space-x-2 hover:opacity-80 transition-all duration-200">
            <Image
              src="/logo.png"
                ...
                {!isCheckingAuth && isAuthenticated && (
                  <>
                    ...
                    {hasPremiumAccess && hasValidSubscription(user) ? (
                      <Link href="/showcases" prefetch={true} className="text-gray-700 hover:text-[#8b7355] font-medium text-sm transition-colors duration-200 flex items-center" title="Showcases">
                        <svg className="w-5 h-5 sm:w-4 sm:h-4 sm:mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <Link href="/upgrade-required" prefetch={true} className="text-gray-400 hover:text-[#8b7355] font-medium text-sm transition-colors duration-200 flex items-center" title="Showcases (Premium Only)">
                        <svg className="w-5 h-5 sm:w-4 sm:h-4 sm:mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <Link href="/settings/subscription" prefetch={true} className="text-gray-700 hover:text-[#8b7355] font-medium text-sm transition-colors duration-200 flex items-center" title="Manage Subscription">
                      <svg className="w-5 h-5 sm:w-4 sm:h-4 sm:mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
