...
function FAQItem({ faq, index, isVisible }: { faq: { question: string; answer: string }; index: number; isVisible: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        <h5 className="text-lg font-semibold text-gray-900 pr-8">{faq.question}</h5>
        <div className={`flex-shrink-0 w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center transition-transform duration-300 ${isOpen ? 'rotate-180 bg-[#8b7355]/10 text-[#8b7355]' : 'text-gray-500'}`}>
  ...
  return (
    <div className="min-h-screen bg-[#faf9f7] flex flex-col overflow-hidden relative">
      ...
      <div className="relative z-10 py-20 lg:py-32">
        <div className="max-w-6xl mx-auto px-6">
          <div className={`text-center mb-16 transform transition-all duration-1000 delay-400 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <h3 className="text-4xl font-extrabold text-gray-900 mb-6 tracking-tight">Experience the Future</h3>
            <p className="text-xl text-gray-600 font-light max-w-2xl mx-auto">
              See how OpenHousePal seamlessly bridges the gap between physical visits and digital conversion.
            </p>
          </div>
          <div className={`relative rounded-3xl overflow-hidden shadow-[0_30px_60px_-15px_rgba(0,0,0,0.3)] ring-1 ring-gray-900/5 transform transition-all duration-1000 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
      ...
      <div id="how-it-works" className="relative z-10 py-24 bg-white/50 overflow-hidden">
        <div className="max-w-6xl mx-auto px-6">
          <div className={`text-center mb-24 transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <h3 className="text-5xl font-extrabold text-gray-900 mb-6 tracking-tight">How It Works</h3>
            <p className="text-xl text-gray-600 font-light max-w-2xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="absolute left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-[#8b7355]/20 via-[#8b7355]/50 to-[#8b7355]/20 hidden md:block -translate-x-1/2"></div>
            
            {/* Mobile Line (Left) */}
            <div className="absolute left-8 top-0 bottom-0 w-px bg-gradient-to-b from-[#8b7355]/20 via-[#8b7355]/50 to-[#8b7355]/20 md:hidden"></div>
              ...
              {[
                ...
                <div key={index} className={`relative flex flex-col md:flex-row items-center justify-between group ${index % 2 === 0 ? '' : 'md:flex-row-reverse'}`}>
                  ...
                  <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 hidden md:flex items-center justify-center w-12 h-12 rounded-full bg-white border-4 border-[#faf9f7] shadow-lg z-10 group-hover:scale-110 transition-transform duration-300">
                    <div className="w-4 h-4 bg-[#8b7355] rounded-full"></div>
                  </div>
                  ...
                  <div className="w-full md:w-[45%] pl-20 md:pl-0 mb-8 md:mb-0 flex justify-center">
                    <div className={`relative w-full ${item.image ? 'max-w-lg' : 'max-w-sm'} aspect-[4/3] ${item.image ? '' : 'bg-gradient-to-br from-[#8b7355] to-[#6b5a43] rounded-3xl shadow-2xl'} flex items-center justify-center transform transition-all duration-500 hover:scale-105 hover:rotate-1 ${item.image ? '' : 'group-hover:shadow-[#8b7355]/30'} ${index % 2 === 0 ? 'md:mr-auto' : 'md:ml-auto'}`}>
                      ...
                      <div className="absolute -bottom-6 inline-flex items-center px-6 py-3 bg-white rounded-xl shadow-xl">
                        <span className="text-4xl font-black text-[#8b7355] mr-3">{item.step}</span>
                  ...
                  <div className={`w-full md:w-[45%] pl-20 md:pl-0 ${index % 2 === 0 ? 'md:text-right md:pr-12' : 'md:text-left md:pl-12'}`}>
                    ...
                    <div className="absolute left-8 top-0 -translate-x-1/2 flex md:hidden items-center justify-center w-10 h-10 rounded-full bg-[#8b7355] text-white font-bold shadow-lg border-4 border-[#faf9f7] z-10">
                      {item.step}
                    </div>
      ...
      <div id="pricing" className="py-24 relative overflow-hidden">
        {/* Background Accent */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[1000px] bg-[#8b7355]/3 rounded-full blur-[120px] -z-10" />

        <div className={`text-center mb-16 transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <span className="text-[#8b7355] font-bold tracking-wider uppercase text-sm mb-4 block">Simple Pricing</span>
          <h3 className="text-5xl font-extrabold text-gray-900 mb-6 tracking-tight">Invest in Your Growth</h3>
          
          {/* Trial Banner */}
          <div className="inline-flex items-center gap-6 px-6 py-3 bg-white rounded-full border border-gray-200 shadow-sm text-sm text-gray-600 mt-4">
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto px-6 items-start">
          ...
          <div className={`bg-white rounded-[2rem] p-10 border border-gray-100 shadow-[0_20px_50px_rgba(0,0,0,0.05)] transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'} relative transition-all hover:shadow-[0_30px_60px_rgba(0,0,0,0.08)]`}>
            <div className="text-center mb-10">
              <h4 className="text-xl font-bold text-gray-900 mb-4 uppercase tracking-wide">Basic Plan</h4>
              <div className="flex items-baseline justify-center mb-2">
                <span className="text-5xl font-black text-gray-900 tracking-tight">$49.95</span>
            ...
            <Link
              href="/register"
              className="block w-full text-center px-6 py-4 bg-gray-100 text-gray-900 rounded-xl font-bold hover:bg-gray-200 transition-colors"
            >
              Select Basic
            </Link>
          </div>
          ...
          {/* Premium Plan */}
          <div className={`bg-[#1a1614] rounded-[2rem] p-10 shadow-[0_30px_80px_-20px_rgba(139,115,85,0.4)] transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'} relative border border-gray-800 flex flex-col overflow-hidden`}>
            {/* Gradient Background */}
            <div className="absolute inset-0 bg-gradient-to-br from-[#1a1614] via-[#2c241b] to-[#3d3226] z-0"></div>
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#8b7355]/20 rounded-full blur-[80px] z-0"></div>
            
            <div className="relative z-10">
              <div className="flex justify-between items-start mb-10">
                <div>
                  <h4 className="text-xl font-bold text-white mb-2 uppercase tracking-wide">Premium Plan</h4>
                  <div className="inline-block bg-[#ffd700] text-[#1a1614] text-xs font-bold px-3 py-1 rounded-md">
                    MOST POPULAR
                  </div>
                </div>
              ...
              <div className="space-y-6 mb-12">
                <div className="bg-white/10 rounded-xl p-5 border border-white/10 backdrop-blur-sm">
                  <div className="flex items-center text-white font-bold mb-2">
                    <svg className="w-5 h-5 text-[#ffd700] mr-2" fill="currentColor" viewBox="0 0 20 20">
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={index} className="flex items-start text-gray-200 font-medium">
                      <div className="w-5 h-5 bg-[#8b7355]/30 rounded-full flex items-center justify-center mr-3 mt-0.5 flex-shrink-0">
              ...
              <Link
                href="/register"
                className="block w-full text-center px-6 py-4 bg-gradient-to-r from-[#8b7355] to-[#6b5a43] text-white rounded-xl font-bold text-lg hover:shadow-lg hover:shadow-[#8b7355]/30 transition-all duration-300 hover:-translate-y-1"
              >
                Start Premium Trial
              </Link>
      ...
      <div id="faq" className="py-24">
        <div className="max-w-4xl mx-auto px-6">
          <div className={`text-center mb-16 transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <h3 className="text-4xl font-extrabold text-gray-900 mb-6 tracking-tight">Questions?</h3>
      ...
      {/* Footer */}
      <footer className="bg-[#1a1614] text-white py-20 border-t border-[#8b7355]/20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
            ...
            {/* Product Links */}
            <div>
              <h5 className="font-bold text-lg mb-6 text-[#8b7355]">Platform</h5>
            ...
            {/* Legal Links */}
            <div>
              <h5 className="font-bold text-lg mb-6 text-[#8b7355]">Legal</h5>
              <ul className="space-y-4 text-sm text-gray-400">
